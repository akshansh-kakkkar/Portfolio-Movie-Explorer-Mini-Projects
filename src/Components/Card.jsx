...
const Card = () => {
  ...
  const User = Info[cardIndex];

  const PreviousCard = () => {
    setCardIndex((prev) => (prev - 1 + Info.length) % Info.length);
  };
  const NextCard = () => {
    setCardIndex((prev) => (prev + 1) % Info.length);
  };
  return (
    <div
            ...
            >
              ...
              <div className="py-12 flex justify-around">
                ...
                <div className="flex gap-4 items-center">
                  <span onClick={PreviousCard}>
                    <img
                      src={
                        theme
                          ? "assets/left-white.svg"
                          : "assets/left-black.svg"
                      }
                      style={{ width: 20 }}
                      alt="previous"
                    />
                  ...
                  <span onClick={NextCard}>
                    <img
                      src={
                        theme
                          ? "assets/right-white.svg"
                          : "assets/right-black.svg"
                      }
                      style={{ width: 20 }}
                      alt="next"
                    />
                ...
                >
                  <span>
                    <img
                      src={
                        theme
                          ? "assets/unfille-heart-white.svg"
                          : "assets/unfille-heart.svg"
                      }
                      style={{ width: 30 }}
                      alt="like"
                    />
                ...
                <div
                  className="gap-2 flex items-center text-center bg-blue-400 py-1 px-3 rounded-xl cursor-pointer"
                  onClick={mail}
                >
                  <span>
                    <img
